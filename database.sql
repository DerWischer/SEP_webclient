...
CREATE TABLE if not exists filesystem (id varchar(36) PRIMARY KEY, filename varchar(250), owner varchar(36), path varchar(1000), file_ext varchar(10), parent varchar(36), hashvalue varchar(128), size int, created int, updated int, type varchar(36), deleted int(1) DEFAULT 0);
