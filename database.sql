...
USE octoprint;
CREATE TABLE if not exists users (id varchar(36) PRIMARY KEY, name varchar(25), pin varchar(5), privilege varchar(1));
...
INSERT IGNORE INTO users VALUES ("3", "admin", "3333", "3");
INSERT IGNORE INTO users VALUES ("2", "manager", "2222", "2");
INSERT IGNORE INTO users VALUES ("1", "user", "1111", "1");
